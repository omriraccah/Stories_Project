...
PTBSetSoundInputDevice(sounddevice); %% SET AUDIO DEVICE
PTBSoundKeyLevel = 10; %% THRESHOLD FOR  TRIGGER

PTBSetSoundKeyLevel(300)

PTBSoundInputDevice = 1;

mkdir([basedir 'TaskData/StoryDataFileSub' SubjStr '/recall_wavFiles'])
PTBRecordAudioFileNames = [SubjStr, '_' num2str(iStory), '_', num2str(Reader), '_recollection']; %% NAME OF WAV FILE AND STRUCTURE
PTBSoundNameFirst = 1;
...
save([basedir 'TaskData/StoryDataFileSub' SubjStr 'Story' num2str(iStory) '.mat'],'TaskDataFile')
